...
const (
	FinalizerString = "finalizers.emrserverless.services.k8s.aws/Application"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("applications")
	GroupKind            = metav1.GroupKind{
		Group: "emrserverless.services.k8s.aws",
		Kind:  "Application",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.Application{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.Application),
	}
}
