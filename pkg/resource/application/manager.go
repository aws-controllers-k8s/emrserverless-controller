...
// +kubebuilder:rbac:groups=emrserverless.services.k8s.aws,resources=applications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=emrserverless.services.k8s.aws,resources=applications/status,verbs=get;update;patch
